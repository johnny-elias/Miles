...
function testAuth() {
    return __awaiter(this, void 0, void 0, function () {
        var user, authResult, wrongAuth, error_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, auth_1.AuthService.authenticateUser({
                            username: 'testuser',
                            password: 'password123'
                        })];
                case 2:
                ...
                case 6:
                    error_1 = _a.sent();
                    console.log('✅ Duplicate user correctly rejected:', error_1.message);
                    return [3 /*break*/, 7];
                case 7:
